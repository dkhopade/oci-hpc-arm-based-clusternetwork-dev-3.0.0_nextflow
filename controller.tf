...
resource "null_resource" "controller" {
  ...
  triggers = {
    controller                   = oci_core_instance.controller.id
    cloud_init_script            = filesha256("${path.module}/cloud-init.sh")
    setup_ansible_script         = filesha256("${path.module}/bin/setup_ansible.sh")
    setup_python_packages_script = filesha256("${path.module}/bin/setup_python_packages.sh")
    setup_run_ansible_script     = filesha256("${path.module}/bin/setup_run_ansible.sh")
    grafana_setup_tasks          = filesha256("${path.module}/playbooks/roles/grafana/tasks/setup_grafana.yml")
    nextflow_install_tasks       = filesha256("${path.module}/playbooks/roles/nextflow/tasks/main.yml")
    compute_playbook             = filesha256("${path.module}/playbooks/compute.yml")
    login_playbook               = filesha256("${path.module}/playbooks/login.yml")
    nextflow_playbook            = filesha256("${path.module}/playbooks/nextflow.yml")
    openldap_defaults            = filesha256("${path.module}/playbooks/roles/openldap/defaults/main.yml")
    openldap_debian_tasks        = filesha256("${path.module}/playbooks/roles/openldap/tasks/debian.yml")
    openldap_el_tasks            = filesha256("${path.module}/playbooks/roles/openldap/tasks/el.yml")
    openldap_local_schema        = filesha256("${path.module}/playbooks/roles/openldap/files/local_schema.ldif")
    openldap_local_policy        = filesha256("${path.module}/playbooks/roles/openldap/files/local_policy.ldif")
    prometheus_tasks             = filesha256("${path.module}/playbooks/roles/prometheus/tasks/main.yml")
    prometheus_targets_tasks     = filesha256("${path.module}/playbooks/roles/prometheus_targets/tasks/sync_targets.yml")
    node_exporter_el_tasks       = filesha256("${path.module}/playbooks/roles/metrics-exporter/tasks/node_exporter_el.yml")
    slurm_defaults               = filesha256("${path.module}/playbooks/roles/slurm/defaults/main.yml")
    slurm_backup_server_tasks    = filesha256("${path.module}/playbooks/roles/slurm/tasks/backup_server.yml")
    slurm_handlers               = filesha256("${path.module}/playbooks/roles/slurm/handlers/main.yml")
    slurm_server_tasks           = filesha256("${path.module}/playbooks/roles/slurm/tasks/server.yml")
    slurm_conf_template          = filesha256("${path.module}/playbooks/roles/slurm/templates/slurm.conf.j2")
    slurmdbd_conf_template       = filesha256("${path.module}/playbooks/roles/slurm/templates/slurmdbd.conf.j2")
    slurm_rest_api_defaults      = filesha256("${path.module}/playbooks/roles/slurm_rest_api/defaults/main.yml")
    slurm_rest_api_restd_tasks   = filesha256("${path.module}/playbooks/roles/slurm_rest_api/tasks/slurm_restd.yml")
    slurm_rest_api_sdk_tasks     = filesha256("${path.module}/playbooks/roles/slurm_rest_api/tasks/slurm_sdk.yml")
    slurm_rest_api_service       = filesha256("${path.module}/playbooks/roles/slurm_rest_api/templates/slurmrestd.service.j2")
  }
...
resource "null_resource" "cluster" {
  ...
  triggers = {
    controller                   = oci_core_instance.controller.id
    inventory_template           = filesha256("${path.module}/inventory.tpl")
    initial_configs_template     = filesha256("${path.module}/conf/initial_configs.conf")
    setup_ansible_script         = filesha256("${path.module}/bin/setup_ansible.sh")
    setup_python_packages_script = filesha256("${path.module}/bin/setup_python_packages.sh")
    setup_run_ansible_script     = filesha256("${path.module}/bin/setup_run_ansible.sh")
    grafana_setup_tasks          = filesha256("${path.module}/playbooks/roles/grafana/tasks/setup_grafana.yml")
  ...
  provisioner "file" {
    content = templatefile("${path.module}/inventory.tpl", {
      ...
      preemptible_partition       = var.preemptible_partition,
      preemptible_partition_count = var.preemptible_partition_count,
...
resource "null_resource" "configure" {
  ...
  triggers = {
    ...
    site_playbook              = filesha256("${path.module}/playbooks/site.yml")
    grafana_setup_tasks        = filesha256("${path.module}/playbooks/roles/grafana/tasks/setup_grafana.yml")
    openldap_defaults          = filesha256("${path.module}/playbooks/roles/openldap/defaults/main.yml")
    openldap_debian_tasks      = filesha256("${path.module}/playbooks/roles/openldap/tasks/debian.yml")
    openldap_el_tasks          = filesha256("${path.module}/playbooks/roles/openldap/tasks/el.yml")
